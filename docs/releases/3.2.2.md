...
class attribute. See [#656](https://github.com/fgmacedo/python-statemachine/issues/656).
...
effect at trigger time, see
[#655](https://github.com/fgmacedo/python-statemachine/issues/655):
