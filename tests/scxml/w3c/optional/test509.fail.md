...
DEBUG    statemachine.engines.sync:sync.py:116 External event: TriggerData(machine=<weakproxy at 0x7f21a2129940; to 'statemachine.io.test509' at 0x7f21a1e4a900>, event=Event('timeout', delay=2000.0, internal=False), send_id='9474d5f9eb2a4c2792496430232cb5ff', _target=None, execution_time=1733943929.9744425, model=Model(state=fail), args=(), kwargs={})
