...
DEBUG    statemachine.engines.async_:async_.py:381 Enabled transitions: {transition  from S0 to S1}
...
DEBUG    statemachine.engines.async_:async_.py:224 Entering state: S1
DEBUG    statemachine.engines.async_:async_.py:369 Macrostep: eventless/internal queue
DEBUG    statemachine.io.scxml.actions:actions.py:204 Cond var2 == 'this is a string' -> False
DEBUG    statemachine.engines.async_:async_.py:381 Enabled transitions: {transition  from S1 to Fail}
