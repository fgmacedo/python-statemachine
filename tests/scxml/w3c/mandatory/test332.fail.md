...
Traceback (most recent call last):
  File "/home/macedo/projects/python-statemachine/statemachine/io/scxml/actions.py", line 463, in __call__
    action(*args, **kwargs)
    ~~~~~~^^^^^^^^^^^^^^^^^
  File "/home/macedo/projects/python-statemachine/statemachine/io/scxml/actions.py", line 341, in send_action
    raise ValueError(f"Invalid target: {target}. Must be one of {_valid_targets}")
ValueError: Invalid target: baz. Must be one of (None, '#_internal', 'internal', '#_parent', 'parent')
...
```py
DebugEvent(source='s0', event='error.execution', data='{\'event_id\': None, \'error\': ValueError("Invalid target: baz. Must be one of (None, \'#_internal\', \'internal\', \'#_parent\', \'parent\')")}', target='fail')
```
